...
- [x] **Math Lab**: readiness-based skill paths with Build, See & Write; Practice & Columns; Frames & Number Lines; and Variety presentation lenses; guided subtraction and place-value lessons are part of the main path — see [06-math-readiness.md](06-math-readiness.md).
