...
- **Words** — tiered spelling with speech and hints.
...
- **Math curriculum work goes in the shipped Math experience** ([06](06-math-methods-beta.md)). Its internal mode id remains `mathlab` for saved-score compatibility; the old `math.js` mode is unregistered pending removal.
